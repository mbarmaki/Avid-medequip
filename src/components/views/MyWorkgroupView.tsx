        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 bg-white/10 backdrop-blur-md px-4 py-3 rounded-2xl border border-white/15 shrink-0">
            <div className="text-center border-l border-white/15 pl-3">
              ...
              <span className="text-[10px] text-sky-200">پرسنل زیرمجموعه</span>
            </div>
            <div className="text-center">
              <span className="text-lg font-black text-amber-300 block">{delayedDrafts.length}</span>
              <span className="text-[10px] text-sky-200">پیش‌نویس بلاتکلیف</span>
            </div>
          </div>
        </div>
      </div>
