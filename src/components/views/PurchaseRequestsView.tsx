...
export const PurchaseRequestsView: React.FC<PurchaseRequestsViewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">
            فرآیند هوشمند تصویب درخواست‌های خرید ملزومات و تجهیزات پزشکی بیمارستان (بدون معطلی تایید دپارتمان)
          </p>
        </div>
      ...
      <div className="bg-blue-50/70 border border-blue-200/80 rounded-3xl p-5 space-y-3">
        <div className="flex items-center justify-between flex-wrap gap-2">
          <div className="flex items-center gap-2 text-blue-900 font-extrabold text-xs">
            <ShieldCheck className="w-4 h-4 text-[#2b64f6]" />
            <span>منطق اصلاح‌شده چرخه تصویب درخواست‌های خرید بیمارستان:</span>
          </div>
          <span className="text-[10px] bg-blue-200/80 text-blue-900 px-2.5 py-0.5 rounded-full font-bold">
            بدون نیاز به تأیید رئیس دپارتمان
          </span>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-[11px] text-blue-950/90 font-medium">
          <div className="bg-white/80 p-3 rounded-2xl border border-blue-100 space-y-1">
            <span className="font-extrabold text-blue-900 block">الف) ثبت توسط کاربران عملیاتی (پرستار، تکنسین، رئیس دپارتمان):</span>
            <p className="text-slate-600 leading-relaxed text-[11px]">
              ۱. ثبت درخواست ➔ ۲. بررسی و تأیید مدیر اموال و موجودی ➔ ۳. تأیید مسئول مالی ➔ ۴. تعیین سبد خرید توسط مسئول خرید
            </p>
          </div>
          <div className="bg-white/80 p-3 rounded-2xl border border-blue-100 space-y-1">
            <span className="font-extrabold text-blue-900 block">ب) ثبت مستقیم توسط مدیر اموال و موجودی:</span>
            <p className="text-slate-600 leading-relaxed text-[11px]">
              ۱. ثبت درخواست مستقیم ➔ ۲. تأیید مسئول مالی (مرحله اموال خودکار رد می‌شود) ➔ ۳. تعیین سبد خرید توسط مسئول خرید
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-3xl max-w-lg w-full p-6 shadow-2xl border border-slate-200 space-y-4 max-h-[90vh] overflow-y-auto">
            ...
            {isAssetManager ? (
              ...
              <div className="p-3 bg-sky-50 border border-sky-100 rounded-2xl text-[11px] text-sky-900 space-y-1">
                <span className="font-bold block">📋 فرآیند درخواست کاربران عملیاتی:</span>
                <p className="leading-relaxed">
                  پس از ثبت، درخواست مستقیماً به کارتابل مدیر اموال و موجودی ارسال می‌شود و نیازی به تأیید رئیس دپارتمان ندارد.
                </p>
              </div>
            )}
            ...
            >
              ...
              <div>
                ...
                <input
                  required
                  name="requesterName"
                  defaultValue={currentUser?.name || 'دکتر مریم کاظمی'}
                  className="w-full p-2.5 rounded-xl bg-slate-50 border border-slate-200 focus:outline-none focus:border-sky-400 font-medium"
                />
              </div>
