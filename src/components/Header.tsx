                    ...
                    notificationsList.map((n) => (
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (n.sourceType === 'draft' && n.targetEquipmentId) {
                            if (onNavigateToInventoryWithAction) {
                              onNavigateToInventoryWithAction({
                                initialTab: 'drafts',
                                actionGuidance: {
                                  type: 'draft_tagging',
                                  title: 'تکمیل پیش‌نویس شناسنامه اموال',
                                  description: 'این قلم فاقد کد اموال قطعی، شماره سریال یا محل استقرار است. لطفاً فرم پیش‌نویس را ویرایش و نهایی فرمایید.',
                                  targetDraftId: n.targetEquipmentId,
                                },
                              });
                            } else {
                              setActivePage('inventory');
